...
class InventoryPage(BasePage):
    ...
    def click_product(self, name):
        elements = self.get_element_by_name(self.products_lists_locator, name)
        element = elements.find_element(By.TAG_NAME, 'a')
        element.click()

    def click_add_to_cart(self, name):
        element = self.get_element_by_name(self.products_lists_locator, name)
